...
class AllDonorsScreen extends StatelessWidget {
                  ...
                  children: [
                    ...
                    ListView.separated(
                      ...
                      itemBuilder: (context, index) =>
                          buildPostItem(context, cubit.dataModel[index]),
  ...
  Widget buildPostItem(context, model) => Card(
        clipBehavior: Clip.antiAliasWithSaveLayer,
        elevation: 5.0,
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Icon(IconBroken.Document,size: 25.0,color: Colors.white,),
                                SizedBox(width: 8.0,),
                                Text('قبول',style: TextStyle(color: Colors.white,fontSize: 20.0),)
                              ],
                            ),
                          ),
                        ),
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Icon(IconBroken.Delete,size: 25.0,color: Colors.white,),
                                SizedBox(width: 8.0,),
                                Text('حذف',style: TextStyle(color: Colors.white,fontSize: 20.0),)
                              ],
                            ),
                          ),
                        ),
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Icon(IconBroken.Calling,size: 25.0,color: Colors.white,),
                                SizedBox(width: 8.0,),
                                Text('اتصال',style: TextStyle(color: Colors.white,fontSize: 20.0),)
                              ],
                            ),
                          ),
                        ),
